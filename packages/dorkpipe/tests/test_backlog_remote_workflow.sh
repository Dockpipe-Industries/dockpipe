...
test "$validation_input_file_count" -eq 136
...
grep -Fq '"fingerprint": "sha256:614e72c68c0ba7816f91f1c5e10896dffca647b2b77835de2192a24747117904"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:617cf73889bb8b73ff357b97d77f1652f4cf401126a7a3da1a020f39a0220814"' "$artifact_root/validation-receipt.json"
