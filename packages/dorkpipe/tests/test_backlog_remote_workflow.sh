...
test "$validation_input_file_count" -eq 148
...
grep -Fq '"fingerprint": "sha256:8bd7315f1e91101550c2af33b18f49631d66f56b0e14053b770d5359cc17146e"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:dbb9dbce650628f35486ba2618bd23622d677c64e4ed3cf4f416ce6b9fa994b8"' "$artifact_root/validation-receipt.json"
