...
test "$validation_input_file_count" -eq 162
...
grep -Fq '"fingerprint": "sha256:deadaa7f8d3422e7eaf3cbc5a8e8d1158aa66d10c40dae08e069c7e977a0fe75"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:2afa3961f762b01c1943d8e220fec6ebd8ff4b9c854ce84657890a1e1d1f3d75"' "$artifact_root/validation-receipt.json"
