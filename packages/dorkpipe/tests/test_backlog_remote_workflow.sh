...
grep -Fq '"fingerprint": "sha256:1e37237f0688876e9f258bf051f4ce093bebac814ce2eb11b4c44835ab31a40c"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:63c884551fc5bd49c1ccb12d767998e118d68203d0a8bac3ba82329f4886fedc"' "$artifact_root/validation-receipt.json"
