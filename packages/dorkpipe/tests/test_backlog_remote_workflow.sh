...
test "$validation_input_file_count" -eq 176
...
grep -Fq '"fingerprint": "sha256:deb8396ce77e9465ce18e2f26a317f33d3b8d92114a7e271084ec5bb6333ecb0"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:1c890bb2bc45337d8cf12353867887afa4bc075104fdf1f4ebb92a536a1eef76"' "$artifact_root/validation-receipt.json"
