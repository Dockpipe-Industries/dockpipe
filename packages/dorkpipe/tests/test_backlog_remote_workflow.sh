...
test "$validation_input_file_count" -eq 140
...
grep -Fq '"fingerprint": "sha256:39b56ed63293852847b36987103bc7d364521e60a7f39b0a0d94350bcb0435ea"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:c62720aba30a7d7407235d81a28313d96b7fc8ab94d5173ab5e027aa56fcc6a3"' "$artifact_root/validation-receipt.json"
