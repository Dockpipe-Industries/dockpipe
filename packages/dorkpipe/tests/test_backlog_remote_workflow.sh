...
grep -Fq '"fingerprint": "sha256:f4020b17baed49e3aa4a9b4ba04a0cb4861691667ff260ce0d6c550b28ac6aa1"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:6068fdabfd240449efa7bf765190499117a6de84c35f51def4b4f5cf3c820845"' "$artifact_root/validation-receipt.json"
