...
test "$validation_input_file_count" -eq 170
...
grep -Fq '"fingerprint": "sha256:9f7ad48978255973aa94174a8f89f90915634efbc6bf3e0000b45792ce5fab95"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:f4d3ab94b8506f922202213227c2d4e88e6bb8fc61c24da33ce9e90ce38e7e0c"' "$artifact_root/validation-receipt.json"
