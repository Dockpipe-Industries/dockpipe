...
test "$validation_input_file_count" -eq 168
...
grep -Fq '"fingerprint": "sha256:1f8df78d7c369286c207a93b5720b6a90a3c04fca3fdbab2267fdc0bd1f77836"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:b99571a859fe92874e41fd829d3c4032997392ee8f2d27a493d74214d5c593ab"' "$artifact_root/validation-receipt.json"
