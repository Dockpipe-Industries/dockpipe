...
grep -Fq '"fingerprint": "sha256:58cf3edc46f710a4641fe0df3be2996e6499a868f7c011c61f7dece9a7570d9e"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:1295d9e80d2c0a9ac66dabcf269a891c4dca4f8996acffe2ada394dabec6c08a"' "$artifact_root/validation-receipt.json"
