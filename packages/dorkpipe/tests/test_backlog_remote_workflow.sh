...
test "$validation_input_file_count" -eq 142
...
grep -Fq '"fingerprint": "sha256:074a8a8c3f406a598779f99720affe37bd466f7960eb8fba59924b181df9c4f9"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:6a02f8846e1f7811fb4029208d0c343e2e6fec34c5a75894721afa74f19e2a31"' "$artifact_root/validation-receipt.json"
