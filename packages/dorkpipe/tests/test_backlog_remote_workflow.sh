...
test "$validation_input_file_count" -eq 178
...
grep -Fq '"fingerprint": "sha256:1d53989ce21769af65dbcadc027f50a011efc5e77b89d95a88ce4ee2b9d9559f"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:8d188b8a85f7d62799ff5a874783d65006f2c9e7b7d8c23f1a9a99d090556c53"' "$artifact_root/validation-receipt.json"
