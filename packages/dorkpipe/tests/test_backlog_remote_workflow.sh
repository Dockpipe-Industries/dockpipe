...
test "$validation_input_file_count" -eq 138
...
grep -Fq '"fingerprint": "sha256:71a5a7df635321f427a0904147d64cde15dcd9166ea79095936e24149943f995"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:06b7ec03459a8110fdd5956438d30b4d573907e12bc807c3a170cbb34fb47825"' "$artifact_root/validation-receipt.json"
