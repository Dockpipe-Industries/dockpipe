...
test "$validation_input_file_count" -eq 156
...
grep -Fq '"fingerprint": "sha256:b9b6178d45264ccb9e072235c0a227f3760aa30b29e016011b61a00036c0ea0b"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:7ba65fb4bf139dabd5d92c7eaf32f4df8e3a65b7ea92f3f88e9f1a0d70f92184"' "$artifact_root/validation-receipt.json"
