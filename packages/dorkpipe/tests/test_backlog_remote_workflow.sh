...
grep -Fq '"fingerprint": "sha256:45679f06570f57ea35894c5f99310d4f0d64629ab356c2639006ee8668c1e700"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:05f84ceb31d7a1c212edb7725246a5c5d2b990edc19bd615be66965481ecbb7a"' "$artifact_root/validation-receipt.json"
