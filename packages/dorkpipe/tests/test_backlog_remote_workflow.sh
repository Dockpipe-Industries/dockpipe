...
grep -Fq '"fingerprint": "sha256:c1b26d3b51d95c5fbd46245495af1f6cab841bfea838a10a16a4e2c9821fea5f"' "$artifact_root/validation-receipt.json"
...
grep -Fq '"compatibility_fingerprint": "sha256:cbcff48848230b232350b1645cb801ae2a12482fb2ff14c5038b02942c7214ab"' "$artifact_root/validation-receipt.json"
