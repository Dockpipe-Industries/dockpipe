...
var toolMinTier = map[string]MCPTier{
	...
	"dorkpipe.provider_pool_approval_request":     TierExec,
	"dorkpipe.provider_pool_approval_decide":      TierExec,
	"dorkpipe.provider_pool_user_input_request":   TierExec,
	"dorkpipe.provider_pool_user_input_respond":   TierExec,
	"dorkpipe.provider_pool_cancellation_request": TierExec,
	"dorkpipe.provider_pool_cancellation_deliver": TierExec,
