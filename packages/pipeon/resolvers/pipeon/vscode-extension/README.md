...
| **DorkPipe: Open context bundle** | Shows the disposable Pipeon package-runtime **`pipeon-context.md`** in an output channel (run `packages/pipeon/resolvers/pipeon/bin/pipeon bundle` in the repo first). |
