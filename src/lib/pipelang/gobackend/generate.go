...
func programNeedsTextSupport(functions []coreir.Function) bool {
	for _, function := range functions {
		if expressionNeedsTextSupport(function.Body) {
			return true
		}
	}
	return false
