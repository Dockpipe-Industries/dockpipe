...
func TestReviewGeneratedOptionalPropagationCompiles(t *testing.T) {
	for _, contract := range []LanguageContract{PipeLangLanguageContractV340, PipeLangLanguageContractV350, PipeLangLanguageContractV360} {
...
func TestReviewGeneratedSafeIndexCompilesAcrossContracts(t *testing.T) {
	for _, contract := range []LanguageContract{PipeLangLanguageContractV330, PipeLangLanguageContractV340, PipeLangLanguageContractV350, PipeLangLanguageContractV360} {
		t.Run(string(contract), func(t *testing.T) {
...
func TestReviewLaterContractsPreserveNamedPredicate(t *testing.T) {
	...
	for _, contract := range []LanguageContract{PipeLangLanguageContractV320, PipeLangLanguageContractV330, PipeLangLanguageContractV340, PipeLangLanguageContractV350, PipeLangLanguageContractV360} {
		t.Run(string(contract), func(t *testing.T) {
