...
func TestCmdPackageCompileCore(t *testing.T) {
	...
	if err := os.MkdirAll(filepath.Join(src, "assets", "scripts", "lib", "__pycache__"), 0o755); err != nil {
		t.Fatal(err)
	}
	...
	fixtureFiles := map[string]string{
		"root-marker.txt":                                       "root source file\n",
		"runtimes/.keep":                                        "",
		"assets/scripts/.retained-core-asset":                   "intentional hidden asset\n",
		"assets/scripts/helper.py":                              "print('source')\n",
		"assets/scripts/helper.pyc.txt":                         "ordinary suffix\n",
		"assets/scripts/generated.pyo":                          "generated bytecode\n",
		"assets/scripts/lib/__pycache__/helper.cpython-310.pyc": "generated cache\n",
		"assets/scripts/lib/__pycache__/ordinary.txt":           "cache passenger\n",
	}
	...
	members, err := packagebuild.ListTarGzMemberPaths(matches[0])
	if err != nil {
		t.Fatal(err)
	}
	for _, retained := range []string{
		"core/root-marker.txt",
		"core/assets/scripts/.retained-core-asset",
		"core/assets/scripts/helper.py",
		"core/assets/scripts/helper.pyc.txt",
	} {
		if !slices.Contains(members, retained) {
			t.Fatalf("expected retained core source %q in tarball; members=%v", retained, members)
		}
	}
	for _, excluded := range []string{
		"core/assets/scripts/generated.pyo",
		"core/assets/scripts/lib/__pycache__/helper.cpython-310.pyc",
		"core/assets/scripts/lib/__pycache__/ordinary.txt",
	} {
		if slices.Contains(members, excluded) {
			t.Fatalf("generated Python cache path %q entered core tarball; members=%v", excluded, members)
		}
	}
