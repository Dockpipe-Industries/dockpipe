// Package clonecmd owns the dockpipe clone command.
package clonecmd
...
// Run clones an allowed compiled workflow into an authoring tree.
func Run(args []string) error {
	...
	return infrastructure.RunOperationWithOptions(
		...
		func() error {
			...
			if err := treecopy.Copy(srcExtracted, toAbs); err != nil {
