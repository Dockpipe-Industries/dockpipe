...
through 7ae, and bounded Step-8 function seams 8a through 8d. The current explicit language
contract is `v0.38.0`; the separately versioned read-only projection is
