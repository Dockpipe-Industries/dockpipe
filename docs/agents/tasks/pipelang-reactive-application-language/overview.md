...
through 7ae, and bounded Step-8 function seams 8a through 8c. The current explicit language
contract is `v0.37.0`; the separately versioned read-only projection is
